---
id: brandonwise
name: Brandonwise v2.2
shortName: Brandonwise
version: 2.2.0
description: Brandon Wise's humanizer (v2.2). Different framing built on Copyleaks stylometric research. Includes Tier 1/2/3 vocabulary system and statistical signal awareness (burstiness, type-token ratio).
isDefault: false
